...
use OCA\Workspace\Groupfolders\Wrapper;
...
class WorkspaceController extends Controller {
	...
	public function createWorkspace(string $spaceName): JSONResponse {
        ...
        $folderId = $this->groupfoldersWrapper->createFolder($spaceName);
		$space = new Space();
        ...
        $this->groupfoldersWrapper->setManageACL(
            $folderId,
            "group",
            $newSpaceManagerGroup->getGid(),
            true
        ...
        $groupfolders = $this->groupfoldersWrapper->getFolder(
            $folderId,
	...
	public function findAll(): JSONResponse {
        ...
        foreach($workspaces as $workspace) {
            $space = array_merge(
                $workspace,
                $this->groupfoldersWrapper->getFolder(
