OC.L10N.register(
    ...
    "You CSV file must follow this structure:" : "Seu arquivo CSV deve seguir esta estrutura:",
    ...
    "A network error occurred while trying to add user {user_name} to workspaces.<br>Error: {error}" : "Ocorreu um erro de rede ao tentar adicionar o usuário {user_name} aos espaços de trabalho.<br>Erro: {error}",
