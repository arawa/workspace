OC.L10N.register(
	'workspace',
	{
		...
		'Workspace groups': 'Groupes d\'espace de travail',
		...
		'Warning, after removal of group <b>{groupname}</b>, its users will lose access to the <b>nouveaux espaces</b> workspace, with the exception of:<br><br>- Workspace Managers (<b>WM-nouveaux espaces</b>)<br>- users who are members of <b>Groupe Workspace</b> (prefixed <b>G-</b>)<br>- users who are members of another Added Group<br>- users manually added from the Workspace <b>nouveaux espaces</b>': 'Attention, après le retrait du groupe <b>{groupname}</b>, les membres de ce groupe perdront l\'accès à l\'espace de travail <b>nouveaux espaces</b>, à l\'exception : <br><br>- des Gestionnaires d\'Espaces (<b>WM-nouveaux espaces</b>)<br>- des utilisateurs embres d\'un <b>Groupe Workspace</b> (préfixé <b>G-</b>)<br>- des utilisateurs membres d\'un autre Groupe Ajouté<br>- des utilisateurs ajoutés manuellement depuis l\'espace de travail <b>nouveaux espaces</b>',
		'Invalid file format. Table header doesn\'t contain any of the following values:<br> {values}': 'Format de fichier est invalide. L\'en-tête du tableau ne contient aucune des valeurs suivantes :<br> {values}',
