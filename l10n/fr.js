OC.L10N.register(
	'workspace',
	{
		...
		'Invalid file format. Table header doesn\'t contain any good values.<br>You have to get 2 columns to specify:<br><br>- The user name or uid : %s<br>- The user role : %s': 'Format de fichier invalide. L\'en-tête ne contient pas les bonnes valeurs<br>Vous devez avoir 2 colonnes pour spécifier:<br><br>- Le nom ou l\'uid de l\'utilisateur : %s<br>- Le rôle de l\'utilisateur : %s',
		...
		'Users doesn\'t exist in your csv file.<br>Please, check these users in your csv file :<br><br>': 'Des utilisateurs n\'existent pas dans votre fichier csv. <br>S\'il vous plait, vérifier ces utilisateurs dans votre fichier csv :<br><br>',
		'Settings': 'Paramètres',
