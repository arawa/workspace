OC.L10N.register(
    ...
    "A network error occurred while trying to add user {user_name} to workspaces.<br>Error: {error}" : "Une erreur réseau s'est produite lors de l'ajout de l'utilisateur {user_name} au workspace.<br>Erreur : {error} ",
