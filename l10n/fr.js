OC.L10N.register(
	'workspace',
	{
		...
		'Your Workspace name must not a blank white into the end or begin its name': 'Le nom de votre Espace de travail ne doit pas contenir d\'espace à la fin ou au début',
		'Email': 'Email',
		'Groups': 'Groupes',
		...
		'Your Workspace name must not contain the following characters: [ ~ < > { } | ; . : , ! ? \' @ # $ + ( ) % \\\\ ^ = / & * ]<br/><br/>And your Workspace name must not a blank white into the begin or end its name': 'Le nom de votre Espace de travail ne doit pas contenir les caractères suivants : [ ~ < > { } | ; . : , ! ? \' @ # $ + ( ) % \\ ^ = / & * ]<br/><br/>Et le nom de votre Espace de travail ne doit pas contenir d\'espace à la fin ou au début',
