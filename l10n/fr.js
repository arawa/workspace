OC.L10N.register(
	'workspace',
	{
		...
		'The content of your file is invalid. Header does not contain the desired values.Two columns are required, with the following header names and values :<br>- "user" : The user\'s UID or email address<br>- "role" : The user\'s role ("u" for a user and "wm" for a workspace manager)': 'Le contenu de votre fichier est invalide. L\'en-tête ne contient pas les valeurs souhaitées.<br>Deux colonnes sont requises, avec les noms d\'en-têtes et valeurs suivantes :<br>- "user": l\'UID ou l\'adresse email de l\'utilisateur<br>- "role": le rôle de l\'utilisateur ("u" pour un utilisateur et "wm" pour un gestionnaire d\'espace)',
		...
		'Users don\'t exist in your csv file.<br>Please, check these users in your csv file :': 'Des utilisateurs n\'existent pas dans votre fichier csv. <br>S\'il vous plait, vérifier ces utilisateurs dans votre fichier csv :<br><br>',
		'Settings': 'Paramètres',
