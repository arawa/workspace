OC.L10N.register(
	'workspace',
	{
		...
		'Invalid file format. Table header doesn\'t contain any good values.<br>You have to get 2 columns to specify:<br><br>- user : The user\'s uid or email<br>- role : The user role': 'Invalid file format. Table header doesn\'t contain any good values.<br>You have to get 2 columns to specify:<br><br>- user : The user\'s uid or email<br>- role : The user role',
		...
		'Users don\'t exist in your csv file.<br>Please, check these users in your csv file :<br><br>': 'Users don\'t exist in your csv file.<br>Please, check these users in your csv file :<br><br>',
