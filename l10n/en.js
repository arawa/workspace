OC.L10N.register(
	'workspace',
	{
		...
		'Invalid file format. Table header doesn\'t contain any good values.<br>You have to get 2 columns to specify:<br><br>- The user name or uid : %s<br>- The user role : %s': 'Invalid file format. Table header doesn\'t contain any good values.<br>You have to get 2 columns to specify:<br><br>- The user name or uid : %s<br>- The user role : %s',
		...
		'Users doesn\'t exist in your csv file.<br>Please, check these users in your csv file :<br><br>': 'Users doesn\'t exist in your csv file.<br>Please, check these users in your csv file :<br><br>',
