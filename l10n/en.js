OC.L10N.register(
	'workspace',
	{
		...
		'Error': 'Error',
		'Your Workspace name must not a blank white into the end or begin its name': 'Your Workspace name must not a blank white into the end or begin its name',
		...
		'Your Workspace name must not contain the following characters: [ ~ < > { } | ; . : , ! ? \' @ # $ + ( ) % \\\\ ^ = / & * ]<br/><br/>And your Workspace name must not a blank white into the begin or end its name': 'Your Workspace name must not contain the following characters: [ ~ < > { } | ; . : , ! ? \' @ # $ + ( ) % \\\\ ^ = / & * ]<br/><br/>And your Workspace name must not a blank white into the begin or end its name',
