OC.L10N.register(
	'workspace',
	{
		...
		'Error in the mimetype': 'Error in the mimetype',
		...
		'The content of your file is invalid. Header does not contain the desired values.Two columns are required, with the following header names and values :<br>- "user" : The user\'s UID or email address<br>- "role" : The user\'s role ("u" for a user and "wm" for a workspace manager)': 'The content of your file is invalid. Header does not contain the desired values.Two columns are required, with the following header names and values :<br>- "user" : The user\'s UID or email address<br>- "role" : The user\'s role ("u" for a user and "wm" for a workspace manager)',
		...
		'Users don\'t exist in your csv file.<br>Please, check these users in your csv file :': 'Users don\'t exist in your csv file.<br>Please, check these users in your csv file :',
