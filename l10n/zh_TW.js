OC.L10N.register(
    ...
    "Error to add group as manager acl" : "新增群組為管理員存取控制清單時發生錯誤",
    "Impossible to add the Space Manager group in Manage ACL groupfolder" : "無法在「管理 ACL 群組資料夾」中新增「空間管理員」群組",
