OC.L10N.register(
    ...
    "Search users" : "搜尋使用者",
    "You CSV file must follow this structure:" : "您的 CSV 檔案必須按照此結構製作：",
    ...
    "Groups" : "群組",
    "View profile" : "檢視個人檔案",
    "Remove admin rights" : "移除管理員權限",
    "Make administrator" : "設定為管理員",
    "Delete user" : "刪除使用者",
    ...
    "A network error occurred while trying to add user {user_name} to workspaces.<br>Error: {error}" : "嘗試新增使用者 {user_name} 到工作空間時發生網路錯誤。<br>錯誤：{error}",
